...
class AppNavigationDrawer extends StatelessWidget {
                      ...
                      onTap: () {
                        _safeCloseDrawerAndNavigate(context, () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => ReferAndEarnScreen(user: user),
                            ),
                          );
                        });
                      },
                      ...
                      onTap: () {
                        _safeCloseDrawerAndNavigate(context, () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => LoyaltyBenefitsScreen(user: user),
                            ),
                          );
                        });
                      },
  ...
  /// Navigates to the dedicated Refer & Earn screen.
  static void showReferAndEarnModal(BuildContext context, UserProfile user) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ReferAndEarnScreen(user: user),
  ...
  /// Navigates to the dedicated Loyalty Benefits screen.
  static void showLoyaltyBenefitsModal(BuildContext context, UserProfile user) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => LoyaltyBenefitsScreen(user: user),
